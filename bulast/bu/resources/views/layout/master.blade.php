...
@foreach($conf as $c)
    ...
    <head>
        ...
        <?php if(request()->segment(1) != 'berita'){ ?>
            ...
            <meta property="og:image" content="{{ url('/') }}/assets/img/banner.png">
            <meta property="og:description" content="Selamat Datang Di Website Kepolisian Resor Landak, Polda Kalimantan Barat | POLRES LANDAK #SIAP MENUJU WBK DAN WBB">
            ...
            <meta name="twitter:description" content="Selamat Datang Di Website Kepolisian Resor Landak, Polda Kalimantan Barat | POLRES LANDAK #SIAP MENUJU WBK DAN WBB">
            <meta name="twitter:image" content="{{ url('/') }}/assets/img/banner.png">
        <?php }else{
            foreach($data as $d):?>
            <title><?= $d->judul ?> - <?= $c->namasitus ?></title>
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <meta name="description" content="<?= substr(preg_replace('~[\\\\/:*?"<>|]~', '', str_replace(array('<p>','</p>'), '', $d->isi)), 0, 150) ?>...">
            <meta name="keywords" content="polri, polisi, landak, kalimantan barat, polres, polres landak, polda kalbar">
            <meta name="robots" content="index, follow">
            <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
            ...
            <meta property="og:image" content="{{ url('/') }}<?= $d->foto ?>">
            <meta property="og:description" content="<?= substr(preg_replace('~[\\\\/:*?"<>|]~', '', str_replace(array('<p>','</p>'), '', $d->isi)), 0, 150) ?>...">
            <meta property="og:site_name" content="POLRES LANDAK PRESISI">
            <meta property="og:locale" content="id_ID">
            ...
            <meta name="twitter:description" content="<?= substr(preg_replace('~[\\\\/:*?"<>|]~', '', str_replace(array('<p>','</p>'), '', $d->isi)), 0, 150) ?>...">
            <meta name="twitter:image" content="{{ url('/') }}<?= $d->foto ?>">
        ...
        <div id="welcome" class="w-screen h-screen fixed z-40 flex justify-center items-center"
            ...
            <div
                ...
                <button type="button" id="close-welcome"
                    class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">SAYA
                    MENGERTI</button>
            </div>
                ...
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <a href="#"
                        ...
                        <button data-collapse-toggle="mobile-menu-2" type="button"
                            class="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg lg:hidden hover:focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
