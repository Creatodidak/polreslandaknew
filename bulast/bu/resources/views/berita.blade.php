...
@foreach($data as $d)
    <section class="pt-2 flex flex-col px-2 gap-2">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <p class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400"><?= $d->satker ?>
                        </p>
                    </div>
                </li>
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span
                            class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400"><?= $d->kategori ?></span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex flex-col md:w-3/4 3xl:w-full md:m-auto p-5 rounded-lg mt-2 bg-gray-800">
            ...
            <section class="bg-white dark:bg-gray-900 py-8" id="komentarsec">
                        ...
                        <article
                            ...
                            <footer class="flex justify-between items-center mb-2">
                                <div class="flex items-center">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400"><?= \Carbon\Carbon::parse($k->created_at)->diffForHumans() ?></p>
                                </div>
                            ...
                            <p class="text-gray-500 dark:text-gray-400"><?= $k->komentar ?></p>
