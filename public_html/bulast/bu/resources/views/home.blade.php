        ...
        <div class="sliderAx h-96">
            <div id="slider-1" class="container mx-auto">
                <div class="bg-black h-96 text-white flex content-center justify-center relative overflow-hidden">
                    <img class="object-cover opacity-10 hover:opacity-50 hover:scale-110 w-full h-96" src="{{ URL::to('/') }}/<?= $beritahumas[0]->foto ?>" alt="<?= $beritahumas[0]->foto ?>" style="transition-timing-function: ease-in; transition: 1s;">
                    <section class='absolute bottom-0 left-0 m-5'>
                        <h1 class="py-2 pl-1 font-bold bg-blue-600 uppercase"><?= $beritahumas[0]->kategori ?></h1>
                        <h2 class="uppercase text-2xl text-bold"><?= $beritahumas[0]->judul ?></h2>
            ...
            <div id="slider-2" class="container mx-auto">
                <div class="bg-black h-96 text-white flex content-center justify-center relative overflow-hidden">
                    <img class="object-cover opacity-10 hover:opacity-50 hover:scale-110 w-full h-96" src="{{ URL::to('/') }}/<?= $beritahumas[1]->foto ?>" alt="<?= $beritahumas[1]->foto ?>" style="transition-timing-function: ease-in; transition: 1s;">
                    <section class='absolute bottom-0 left-0 m-5'>
                        <h1 class="py-2 pl-1 font-bold bg-blue-600 uppercase"><?= $beritahumas[1]->kategori ?></h1>
                        <h2 class="uppercase text-2xl text-bold"><?= $beritahumas[1]->judul ?></h2>
            ...
            <div id="slider-3" class="container mx-auto">
                <div class="bg-black h-96 text-white flex content-center justify-center relative overflow-hidden">
                    <img class="object-cover opacity-10 hover:opacity-50 hover:scale-110 w-full h-96" src="{{ URL::to('/') }}/<?= $beritahumas[2]->foto ?>" alt="<?= $beritahumas[2]->foto ?>" style="transition-timing-function: ease-in; transition: 1s;">
                    <section class='absolute bottom-0 left-0 m-5'>
                        <h1 class="py-2 pl-1 font-bold bg-blue-600 uppercase"><?= $beritahumas[2]->kategori ?></h1>
                        <h2 class="uppercase text-2xl text-bold"><?= $beritahumas[2]->judul ?></h2>
                    ...
                    <figure class="bg-black rounded-2xl overflow-hidden">
                        ...
                        <figcaption class="p-4 bg-gray-800 rounded-b-2xl">
                            ...
                            <small class="leading-5 text-gray-500 dark:text-gray-400">
                                <?= substr($b->isi, 0, 100) ?><a href="{{URL::to('/')}}/berita/<?= $b->link ?>">...Selengkapnya</a>
                            </small>
                            <div class="flex pt-2">
                                <div class="basis basis-10">
                                    <img src="<?= $b->publisherfoto ?>" alt="" class="rounded-full max-w-full h-auto align-middle border-none">
                                </div>
                                <div class="basis-auto pl-3">
                                    <p class="text-sm text-bold text-gray-400"><?= $b->namapublisher ?></p>
                                    <p class="text-xs text-gray-700"><?= $b->satker ?></p>
                                </div>
                            </div>
                        </figcaption>
                    </figure>
